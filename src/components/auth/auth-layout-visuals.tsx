    ...
    <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden">
      ...
      {mounted && platforms.map((platform, index) => (
        <div
          ...
          style={{
            left: `${platform.x}%`,
            top: `${platform.y}%`,
            transform: `translate(-50%, -50%) scale(${activeOrb === index ? 1.2 : 1})`,
            zIndex: activeOrb === index ? 10 : 1,
          }}
        >
          <div
            className={`w-12 h-12 rounded-xl flex items-center justify-center shadow-2xl transition-all duration-500 ${
              activeOrb === index ? "ring-4 ring-white/30" : ""
            }`}
            style={{
      ...
      <div className="relative z-10 flex flex-col justify-between p-12 w-full">
        ...
        <div className="space-y-8 max-w-lg">
          ...
          <div>
            <h1
              className="text-2xl xl:text-3xl font-bold leading-[1.2] mb-4"
              style={{ color: "#ffffff" }}
            >
            ...
            <p className="text-base text-white/70 leading-relaxed">
              Write once, publish everywhere. Let AI optimize your content for
              every social platform automatically.
            </p>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-center gap-2 mb-1">
                    ...
                    <span className="text-2xl xl:text-3xl font-bold text-white">{stat.value}</span>
                  </div>
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <p className="text-white/90 italic mb-4">&ldquo;{testimonial.quote}&rdquo;</p>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#6366f1] to-[#ec4899] flex items-center justify-center text-white font-bold text-sm">
